...
void loop()
{
  ...
  {
    if (temperature <= 20 && temperature >= 0) //if the temperature is within normal range then the light should flash green
    {
      flash_green();
    }
    else if (temperature > 20) //if the temperature reads higher than the normale range then the light should flash red
    {
      flash_red();
    }
    else if (temperature < 0) //if the temperature reads lower than the expected temperature then the lights should flash yellow
  ...
  else if (light_intensity >= 61)
  {
    ...
    else if (temperature < 61) //if the temperature reads lower than the expected temperature then the lights should flash yellow
    {
      flash_yellow();
    }
  }
